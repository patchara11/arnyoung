...
--
-- Host: localhost
-- Generation Time: Dec 17, 2017 at 08:33 AM
...
(80, 34, 1, '2017-12-17 03:16:36'),
(81, 29, 1, '2017-12-17 03:16:38'),
(82, 32, 1, '2017-12-17 03:16:39'),
(83, 33, 1, '2017-12-17 04:31:26'),
(84, 36, 1, '2017-12-17 04:31:27'),
(85, 2, 1, '2017-12-17 04:31:28'),
(87, 28, 1, '2017-12-17 04:31:30');
...
(6, 'dsdxs', 'csww', 'cwc@mail.com', '246476577578', 'qqqq', 13, '2017-12-17 07:20:18'),
(7, 'test2', 'ss', 'cwc@mail.com', '0812345678', 'qqqq', 14, '2017-12-17 07:26:22'),
(8, ' nbvmn', 'gnh', 'cc@hotmail.com', '0812345678', 'aaaaa', 15, '2017-12-17 07:29:02'),
(10, '', '', '', '', '', 17, '2017-12-17 07:30:57'),
(11, 'aaaa', 'bbbb', 'aaa@aaa.com', '0988979797o79o', 'asad', 18, '2017-12-17 07:33:08');
...
CREATE TABLE `payment` (
  ...
  `story_detail_id` int(11) NOT NULL,
  `member_id` int(11) NOT NULL,
  `truemoney` varchar(14) COLLATE utf8_unicode_ci DEFAULT NULL,
  `slip` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `payment` (`payment_id`, `story_header_id`, `story_detail_id`, `member_id`, `truemoney`, `slip`, `payment_confirm`, `timestamp`) VALUES
(10, 33, 41, 1, '11222353535', NULL, 1, '2017-12-11 07:50:44'),
(12, 33, 39, 1, '6666666666666', NULL, 1, '2017-12-16 04:48:36'),
(14, 33, 42, 1, '11132424', NULL, 1, '2017-12-17 03:44:20');
...
(38, 'moijojoijio', 'joijiojoijoomnj ', 's-l1600.jpg', '0.00', 3, 0, 1, '2017-12-17 03:43:32');
...
(14, 'test2', '1234', '2017-12-17 07:26:22'),
(15, 'tdddd', '1234', '2017-12-17 07:29:02'),
(17, '', '', '2017-12-17 07:30:57'),
(18, 'test3', '1234', '2017-12-17 07:33:08');
...
--
ALTER TABLE `like_this`
  MODIFY `like_this_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
--
...
--
ALTER TABLE `story_detail`
  MODIFY `story_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
--
-- AUTO_INCREMENT for table `story_header`
--
ALTER TABLE `story_header`
  MODIFY `story_header_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
--
